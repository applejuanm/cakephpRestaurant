	...
	<table class="table table-striped">
		...
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $categoriaPlatillo['CategoriaPlatillo']['id']), 
				array('class' => 'btn btn-sm btn-danger'),
				__('Are you sure you want to delete # %s?', $categoriaPlatillo['CategoriaPlatillo']['categoria'])); ?>
