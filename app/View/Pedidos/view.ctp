<!---->
<?php
//esta sentencia es lo equivalente a la sentencia debugger de Js
//debug($pedidos);
?>
<!---Agregamos el fichero de javascript--->
...
<?php $tabindex = 1; ?>
<!--Aqui estamos cogiendo el array pedidos que estamos cogiendo de
    pedidos controller, es decir el pedido añadido a la cesta-->
<?php foreach ($pedidos as $pedido) : ?>
    <!--id con el pedido correspondiente-->
    <div class="row" id="row-<?php echo $pedido['Pedido']['id']; ?>">

  <!--Sacamos las fotos del directorio platillos-->
    <div class="col col-sm-1">
        ...
        <!--Input--->
        <div class="col col-sm-1">
            <?php echo $this->Form->input($pedido['Pedido']['id'], array(
                'div' => false, 'class' => 'numeric
            form-control input-small', 'label' => false, 'size' => 2, 'maxlenght' => 2, 'tabindex' => $tabindex++,
                'data-id' => $pedido['Pedido']['id'], 'value' => $pedido['Pedido']['cantidad']
            )); ?>
        </div>
        ...
        <div class="col col-sm-1">
            ...
            echo $this->Html->link(
                ...
                '#',
                array(
                    'escapeTitle' => false, 'title' => 'Eliminar item', 'id' => $pedido['Pedido']['id'],
                    'class' => 'remove'
                )
            );
            ?>
